                ...
                {provider &&
                  Object.values(provider).map((provider, index) => (
                    <button
                      ...
                      className="flex items-center text-blue-700 bg-white hover:bg-blue-900 hover:text-white rounded-md px-3 py-2"
                    >
        ...
        <div id="mobile-menu">
          <div className="space-y-1 px-2 pb-3 pt-2">
            ...
            <Link
              href="/properties"
              className={`${
                pathname === "/properties" ? "bg-white text-blue-700" : ""
              } text-white block rounded-md px-3 py-2 text-base font-medium`}
            >
              Properties
            </Link>
            {session && (
              <Link
                href="/properties/add"
                className={`${
                  pathname === "/properties/add" ? "bg-white text-blue-700" : ""
                } text-white block rounded-md px-3 py-2 text-base font-medium`}
              >
                Add Property
              </Link>
